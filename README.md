...
| --- | --- | --- |
| [North Star - Governed Context & Workflow System](https://github.com/tusharg007/northstar-workload-optimizer) | A governed expense-operations system built around explicit, versioned context, deterministic policy boundaries, provenance, abstention, human approval, and MCP as a controlled interface. | Python, FastAPI, PostgreSQL, MCP, n8n, Metabase, Docker, GitHub Actions |
...
| --- | --- |
| [Internal RFP Analyst](https://github.com/tusharg007/Internal-RFP-Analyst) | Evidence-grounded document intelligence and retrieval agent. |
| [Financial Document Intelligence](https://github.com/tusharg007/financial-document-intelligence-rag) | Hybrid dense + BM25 + reranking pipeline for SEC filings. |
